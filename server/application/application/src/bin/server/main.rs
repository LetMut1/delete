...
mod error;
mod raydium_amm_initialize_instruction_2;
mod server;
mod spawner;
...
impl Processor {
    fn process() -> Result<(), Error> {
        const COMMAND_RUN: &'static str = "run";
        ...
        let arg_matches = clap::command!()
            ...
            .subcommand(Command::new(COMMAND_RUN))
        ...
        match subcommand_arg_matches {
            (COMMAND_RUN, _) => CommandProcessor::<Run>::process(environment_configuration_file_path.as_str()),
